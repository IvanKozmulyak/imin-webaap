    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div className="relative w-full max-w-[440px] md:max-w-[700px] lg:max-w-[800px] px-6 max-h-[90vh] overflow-y-auto">
          {/* Main Card */}
          <div className="relative rounded-[27px] border border-white bg-black/5 backdrop-blur-[15px] px-8 md:px-12 lg:px-16 py-12 md:py-16">
            {/* Title */}
            <h1 className="text-white text-center text-[20px] md:text-[24px] lg:text-[28px] font-bold mb-2">TERMS AND CONDITIONS</h1>
            <p className="text-white/70 text-center text-[12px] md:text-[13px] mb-8">Last Updated: 09.01.2026</p>

            {/* Terms Content */}
            <div className="text-white text-[12px] md:text-[13px] lg:text-[14px] font-normal leading-relaxed space-y-6 mb-8">
              <div>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-[440px] md:max-w-[600px] lg:max-w-[700px] px-6">
        ...
        <div className="relative rounded-[27px] border border-white bg-black/5 backdrop-blur-[15px] px-8 md:px-12 lg:px-16 py-12 md:py-16">
          ...
          {/* Features Container - Horizontal on desktop */}
          <div className="flex flex-col md:flex-row md:justify-between md:gap-8 mb-12 md:mb-16">
            {/* Feature 1: Groups up to 5 people */}
            <div className="flex flex-col items-center mb-8 md:mb-0 md:flex-1">
              <div className="w-[60px] h-[60px] md:w-[70px] md:h-[70px] lg:w-[80px] lg:h-[80px] rounded-full border border-[rgba(136,209,250,0.05)] bg-[rgba(136,209,250,0.10)] flex items-center justify-center mb-4">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
              ...
              <p className="text-white text-center text-[15px] md:text-[16px] font-normal">Groups up to 5 people</p>
            </div>
            ...
            <div className="flex flex-col items-center mb-8 md:mb-0 md:flex-1">
              ...
              <p className="text-white text-center text-[15px] md:text-[16px] font-normal">Mixed-gender groups</p>
            </div>
            ...
            <div className="flex flex-col items-center md:flex-1">
              ...
              <p className="text-white text-center text-[15px] md:text-[16px] font-normal">Just good vibes</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 mb-6 md:mb-8 px-2">
            ...
            <p className="text-white text-[10px] md:text-[11px] lg:text-[12px] font-normal leading-relaxed">
