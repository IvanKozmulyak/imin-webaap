...
function HomeContent() {
  ...
  return (
    <div className={isFestivalStyle ? 'festival-style' : ''}>
      ...
      <section className="markets-section" style={{ padding: '80px 0' }}>
        <div className="container">
            ...
            <div id="contact-form-card" className="glass-card form-target" style={{ maxWidth: '900px', margin: '0 auto', border: isFestivalStyle ? '1px solid var(--glass-border)' : '1px solid var(--glow-green)', textAlign: 'center' }}>
              ...
              >
                <div style={{ gridColumn: 'span 2' }}>
                  <input type="text" className="form-input" placeholder={isFestivalStyle ? 'Festival / Organization Name' : 'Organization Name'} name="organization" required />
                </div>
                <div>
                  <input type="email" className="form-input" placeholder="Work Email" name="email" required />
                </div>
                <div>
                  <select className="form-input" name="annualAttendees" style={isFestivalStyle ? { background: '#F8FAFC' } : { background: 'rgba(0,0,0,0.3)' }}>
